...
class HtmlController(
    ...
    fun blog(model: Model): String {
        ...
        // Tells Spring which template to render -> blog.html, blog.mustache, ...
        // This works because we use a @Controller here (instead of a @RestController
        // which directly returns the data)
        // You can also annotate single functions with @ResponseBody to return data directly.
        return "blog"
    }
